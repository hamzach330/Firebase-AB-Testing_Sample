...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (remoteMessage.notification != null) {
            showNotification(remoteMessage.notification?.title, remoteMessage.notification?.body,remoteMessage)
        }
    }
    ...
    private fun showNotification(title: String?, body: String?,remoteMessage: RemoteMessage?) {
        ...
        intent.putExtra("FlowType", remoteMessage?.data?.get("FlowType"))
